                    ...
                    <div class="row justify-content-center mb-4">
                        <div class="col-md-4 text-center">
                            <label for="profile_picture" class="position-relative d-block"
                                ...
                                <img src="{{ $user->picture_path ?? asset('profile-icon-png-910.png')}}"
                                    alt="Profile Picture" class="rounded-circle border" style="width: 150px; height: 150px; object-fit: cover;" id="preview-profile-picture">
                                <div class="overlay rounded-circle"
                                    ...
                                    <i class="fas fa-upload position-absolute text-white"
                                        style="top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 30px;"></i>
                                </div>
                            </label>
                            ...
                            <input type="file" name="profile_picture" id="profile_picture" class="d-none"
                                ...
                                onchange="document.getElementById('preview-profile-picture').src = window.URL.createObjectURL(this.files[0]);">
